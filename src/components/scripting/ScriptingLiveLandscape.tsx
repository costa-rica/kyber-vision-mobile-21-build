...
interface ScriptingLiveLandscapeProps {
  ...
  handleSetCirclePress: (team: "analyzed" | "opponent", setIndex: number) => void;
  handleSetScorePress: (team: "analyzed" | "opponent", scoreAdjust: number) => void;
...
export default function ScriptingLiveLandscape(props: ScriptingLiveLandscapeProps) {
