...
const initialState: ScriptState = {
  ...
  positionalAreasArray: Array.from({ length: 6 }, (_, i) => i + 1) as readonly number[],
...
export const scriptSlice = createSlice({
  ...
  initialState,
  reducers: {
    updateScriptSessionActionsArray: (state, action: PayloadAction<SessionAction[]>) => {
    ...
    setScriptingForPlayerObject: (state, action: PayloadAction<ScriptingPlayerObject>) => {
      state.scriptingForPlayerObject = action.payload;
    },
    setScriptingTeamObject: (state, action: PayloadAction<ScriptingTeamObject>) => {
      state.scriptingTeamObject = action.payload;
    },
    updateCoordsScriptLivePortraitContainerMiddle: (state, action: PayloadAction<Coordinates>) => {
    ...
    updateCoordsScriptLiveLandscapeContainerLeft: (state, action: PayloadAction<Coordinates>) => {
      state.coordsScriptLiveLandscapeContainerLeft = action.payload;
    },
    updateCoordsScriptLiveLandscapeContainerMiddleTop: (state, action: PayloadAction<Coordinates>) => {
      state.coordsScriptLiveLandscapeContainerMiddleTop = action.payload;
    },
    updateCoordsScriptLiveLandscapeContainerMiddleBottom: (state, action: PayloadAction<Coordinates>) => {
      state.coordsScriptLiveLandscapeContainerMiddleBottom = action.payload;
    },
    updateCoordsScriptLivePortraitVwPlayerSuperSpacer: (state, action: PayloadAction<Coordinates>) => {
      state.coordsScriptLivePortraitVwPlayerSuperSpacer = action.payload;
    },
    updateCoordsScriptLiveLandscapeVwPlayerSuper: (state, action: PayloadAction<Coordinates>) => {
      state.coordsScriptLiveLandscapeVwPlayerSuper = action.payload;
    },
    updateCoordsScriptLiveLandscapeVwBelowSvgVolleyballCourt: (state, action: PayloadAction<Coordinates>) => {
