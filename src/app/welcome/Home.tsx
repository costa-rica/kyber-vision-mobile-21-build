...
export default function Home({ navigation }: HomeScreenProps) {
	...
	const handleNavigationWithTodo = (screenName: string, feature: string) => {
		console.log(`Navigate to ${screenName} - ${feature}`);
		Alert.alert("Coming Soon", `${feature} feature will be implemented soon.`);
	};
